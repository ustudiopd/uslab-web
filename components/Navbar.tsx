        ...
        <div className="flex items-center h-20">
          ...
          <div className="md:hidden flex items-center ml-auto">
            <button
              ...
              className="dark:text-slate-300 text-slate-800 dark:hover:text-white hover:text-slate-900 focus:outline-none"
      ...
      >
        <div className="px-4 py-4 space-y-3">
          <Link
            ...
            className="block px-3 py-2 text-base font-medium dark:text-slate-400 text-slate-700 dark:hover:text-white hover:text-slate-900 dark:hover:bg-slate-800 hover:bg-slate-100 rounded"
          >
            {t('nav.about')}
          </Link>
          <Link
          ...
          <Link
            href={locale === 'ko' ? `/en${basePath}` : `/ko${basePath}`}
            onClick={handleLinkClick}
            className="block w-full text-left px-3 py-2 text-base font-medium dark:text-slate-400 text-slate-700 dark:hover:text-white hover:text-slate-900 dark:hover:bg-slate-800 hover:bg-slate-100 rounded dark:border-slate-800 border-slate-300 mt-2"
          >
