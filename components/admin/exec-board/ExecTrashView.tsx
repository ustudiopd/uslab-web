  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-bold text-white">휴지통</h2>
        <button
          onClick={onClose}
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          <p className="text-slate-400">휴지통이 비어있습니다.</p>
        </div>
      ) : (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-xs bg-green-500/20 border border-green-500/50 text-green-400 rounded hover:bg-green-500/30 transition-colors disabled:opacity-50"
                >
